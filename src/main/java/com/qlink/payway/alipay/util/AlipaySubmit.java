package com.qlink.payway.alipay.util;
...
import com.qlink.payway.alipay.config.AlipayConfig;
import com.qlink.payway.alipay.sign.MD5;
import com.qlink.payway.alipay.util.httpClient.HttpProtocolHandler;
import com.qlink.payway.alipay.util.httpClient.HttpRequest;
import com.qlink.payway.alipay.util.httpClient.HttpResponse;
import com.qlink.payway.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	private static PayConfigService payConfigService = SpringContextHolder.getBean(PayConfigService.class);
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
    		...
    		PayConfig payConfig = payConfigService.findByParameter("alipay", "1");

            String key = null;
            if (payConfig != null)
            	key = payConfig.getPrivateKey();
            else 
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        String gateway = null;
        if (payConfig!=null)
        	gateway = payConfig.getGateway();
        if (StringUtils.isBlank(gateway))
        	gateway = ALIPAY_GATEWAY_NEW;
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = gateway + "service=query_timestamp&partner=" + partner + "&_input_charset" +AlipayConfig.input_charset;
