...
<body>
    ...
    <div class="container">
		...
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.qlink.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
        <div id="login-wraper">
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2017 ${fns:getConfig('productName')}
    </footer>
  </body>
</html>