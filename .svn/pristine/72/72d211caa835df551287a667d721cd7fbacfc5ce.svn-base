...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.qlink.modules";
		
		String moduleName = "thirdparty";			    // 模块名，例：sys
		String subModuleName = "hbc";				// 子模块名（可选），当一个模块下有多个子模块时需要填写！！！
		String className = "Order";			    // 类名，例：user
		String classAuthor = "admin";		    // 类作者，例：admin
		String functionName = "皇包车订单管理";			// 功能名，例：用户
